...
id: T-20260709-017
agent: digester
title: L1压测·harness教程(Claude Code Setup)重跑
project: inspiration
priority: 2
difficulty: light
depends_on: 
...
inventory 标题(以此为准,免查inventory):《Every 3D Artist Should Be Using Claude Code (My Setup)》
品类: ai-harness配置教程
转写(唯一需要读的文件): data/inspiration/stefan-3d-ai/transcripts/d1UKzCq0dw0.txt
禁止读取任何 *.golden.md。
