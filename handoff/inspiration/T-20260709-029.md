...
id: T-20260709-029
agent: digester
title: L1蒸馏·Claude And New UE 5.8 MCP is Crazy Good 
project: inspiration
priority: 2
difficulty: light
depends_on: 
...
处理对象: video_id=I5WLl4MdK28
inventory 标题:《Claude And New UE 5.8 MCP is Crazy Good (But I made it better)》
品类: 未预标注——按规约规则13自行判断品类;与 workflow card 不匹配时写【schema适配备注】再尽力填充。
转写: data/inspiration/stefan-3d-ai/transcripts/I5WLl4MdK28.txt
禁止读取任何 *.golden.md。
