...
id: T-20260709-030
agent: digester
title: L1蒸馏·3D Gaussian Splats in Unreal Engine 5 Is
project: inspiration
priority: 2
difficulty: light
depends_on: 
...
处理对象: video_id=cjfsxL-s31Y
inventory 标题:《3D Gaussian Splats in Unreal Engine 5 Is Insane — and It’s Free》
品类: 未预标注——按规约规则13自行判断品类;与 workflow card 不匹配时写【schema适配备注】再尽力填充。
转写: data/inspiration/stefan-3d-ai/transcripts/cjfsxL-s31Y.txt
禁止读取任何 *.golden.md。
